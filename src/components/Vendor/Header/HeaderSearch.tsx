    ...
    <div ref={wrapperRef} className="relative mx-auto flex max-w-[420px] flex-1 items-center">
      <form onSubmit={handleSubmit} className="relative flex w-full items-center">
        ...
        <input
          ...
          className="h-11 w-full rounded-full border border-nxborder bg-white pl-[34px] pr-20 text-[13px] text-nxi2 outline-none transition-[border-color,box-shadow] focus:border-nxp focus:shadow-[0_0_0_3px_hsl(237_49%_33%/0.1)]"
        />
