...
const GRID =
  'grid grid-cols-[minmax(160px,1.1fr)_minmax(220px,2.2fr)_80px_minmax(120px,1fr)_minmax(150px,1.2fr)_minmax(140px,1fr)_104px] items-center gap-[10px] px-[18px] py-[11px]'
