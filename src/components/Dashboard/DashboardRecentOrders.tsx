  ...
  if (!orders || orders.length === 0) {
    return (
      <Card className="border-0 shadow-sm rounded-2xl">
        <CardHeader>
          <CardTitle className="text-base sm:text-lg font-bold font-integral text-primary">
            Pedidos Recentes
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-center">
            ...
            <p className="text-sm sm:text-base text-gray-500">Nenhum pedido recente</p>
          </div>
        </CardContent>
      </Card>
    )
          ...
          <div className="space-y-3">
            {orders.map((order, index) => {
              ...
              return (
                <div
                  key={order.id}
                  className={`rounded-xl p-3 sm:p-4 bg-white border border-gray-100`}
                >
                  {/* Produto */}
                      ...
                      <>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs sm:text-sm text-gray-500 mt-0.5">
                            Preço: {formatPrice(firstItem.price)}
                          </p>
                        </div>
                      </>
                    ) : (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <span className="text-xs text-gray-600 block mb-0.5">Total</span>
