...
import { LogOut, User, ShoppingBag, TrendingUp, Package, Users } from 'lucide-react'
...
export default function VendedorPage() {
  ...
  useEffect(() => {
    if (!isLoading && !isAuthenticated) {
      router.push('/login')
    } else if (!isLoading && isAuthenticated && user?.profile !== 'Vendedor') {
      const routes = {
        'Administrador': '/admin',
        'Cliente': '/cliente'
      }
  ...
  const vendedorTransactions = PROFILE_TRANSACTIONS.Vendedor
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <CardContent>
              <p className="text-2xl font-bold">Atender</p>
              <p className="text-xs text-muted-foreground">
                Gerenciar clientes
              </p>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {vendedorTransactions.map((transaction) => (
                    <span
                      key={transaction}
                ...
                <p className="text-xs text-gray-500 mt-3">
                  Total: {vendedorTransactions.length} transações
                </p>
              </div>
            </CardContent>
          </Card>
