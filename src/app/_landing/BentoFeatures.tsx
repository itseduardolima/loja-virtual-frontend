      ...
      <div className={s.bento}>
        ...
        <div className={`${s.bcard} ${s.bCat}`}>
          <div className={s.bvis} style={{background:'#F5F6FF'}}>
            <div className={s.bentoProductGrid}>
              {[
                ...
                {grad:'linear-gradient(135deg,#60A5FA,var(--ind))',name:'Tênis branco',price:'R$ 229',colors:['#fff','#0F172A','#60A5FA']},
                {grad:'linear-gradient(135deg,#6EE7B7,var(--emr))',name:'Camisa slim',price:'R$ 139',colors:['var(--emr)','#fff','#334155']},
              ].map((p, i) => (
          ...
          <div className={s.bbody}>
            <span className={s.btag} style={{color:'var(--ind)'}}><span className={s.bdot} style={{background:'var(--ind)'}} />Catálogo</span>
          ...
          <div className={s.bvis} style={{background:'#FBFBFD'}}>
            <div className={s.bentoKanban}>
              {[
                ...
                {label:'Pago',count:5,color:'var(--ind)',orders:[{code:'#118',name:'Lia M.'},{code:'#119',name:'Rui A.'}]},
                {label:'Enviado',count:12,color:'var(--emr)',orders:[{code:'#106',name:'Bia R.'},{code:'#107',name:'Téo L.'}]},
              ].map((col, i) => (
        ...
        <div className={`${s.bcard} ${s.bDash}`}>
          <div className={s.bvis} style={{background:'#F2FCF7'}}>
            ...
            <svg viewBox="0 0 200 56" width="100%" height="52" preserveAspectRatio="none" style={{marginTop:'8px',display:'block'}}>
              ...
              <path d="M0,48 L20,43 L40,45 L60,35 L80,38 L100,28 L120,31 L140,20 L160,18 L180,11 L200,7" fill="none" stroke="var(--emr)" strokeWidth="1.5" />
            </svg>
          </div>
          <div className={s.bbody}>
            <span className={s.btag} style={{color:'var(--emr)'}}><span className={s.bdot} style={{background:'var(--emr)'}} />Dashboard</span>
        ...
        <div className={`${s.bcard} ${s.bExp}`}>
          <div className={s.bbody}>
            <span className={s.btag} style={{color:'var(--emr)'}}><span className={s.bdot} style={{background:'var(--emr)'}} />Exportar</span>
          ...
          <div className={s.bvis} style={{background:'#F2FCF7'}}>
            <div className={s.bentoExportFile}>
              ...
              <div className={s.bentoExportBtn}>
                <Download size={17} color="var(--emr)" />
              </div>
            </div>
          </div>
        </div>
