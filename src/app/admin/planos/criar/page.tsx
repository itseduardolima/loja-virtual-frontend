...
export default function AdminCriarPlanoPage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        <h1 className="text-[26px] font-extrabold tracking-[-0.03em] text-nxi1">Criar Plano</h1>
        <p className="mt-0.5 text-[13px] text-nxi2">Preencha as informações para criar um novo plano de assinatura</p>
      </div>
            ...
            <SectionCard>
              ...
              <FieldGrid columns={1}>
                ...
                <Field>
                  ...
                  <Input id="sort_order" {...register('sort_order')} type="number" defaultValue={0} className={nxInputClass()} />
                </Field>
              </FieldGrid>
            </SectionCard>
